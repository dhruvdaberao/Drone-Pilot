...
const remainingCode = code.substring(code.indexOf('  return (\n    <div className="w-full">', startIndex));

fs.writeFileSync('src/components/digital-twin/configuration-overview.tsx', newCode + remainingCode);
