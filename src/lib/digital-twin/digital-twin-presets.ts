...
const surveyDraft: Partial<DroneDigitalTwinConfiguration> = {
  ...
  airframe: {
    ...
    motorCount: 6,
    armLengthMeters: 0.55,
    frameDiagonalMm: 720,
    frameMaterial: "Carbon Fiber",
    dryMassKg: 3.4,
    dimensions: { lengthM: 0.72, widthM: 0.72, heightM: 0.30 },
    centerOfGravity: { x: 0, y: 0, z: 0 },
    maxPayloadKg: 2.2,
    landingGearType: "Retractable Struts",
  },
  motors: generateRadialMotors(6, 0.55, 7200, 10500, 680, 22.2),
  propeller: {
    diameterInches: 14.0,
    pitchInches: 5.0,
    bladeCount: 2,
...
const heavyDraft: Partial<DroneDigitalTwinConfiguration> = {
  ...
  airframe: {
    ...
    motorCount: 8,
    armLengthMeters: 0.65,
    frameDiagonalMm: 900,
    frameMaterial: "Carbon Fiber",
    dryMassKg: 6.2,
    dimensions: { lengthM: 0.90, widthM: 0.90, heightM: 0.36 },
    centerOfGravity: { x: 0, y: 0, z: 0 },
    maxPayloadKg: 5.5,
    landingGearType: "Retractable Struts",
  },
  motors: generateRadialMotors(8, 0.65, 6800, 9800, 480, 22.2),
  propeller: {
    diameterInches: 16.0,
    pitchInches: 6.0,
    bladeCount: 2,
