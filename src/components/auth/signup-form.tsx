      ...
      <div className="space-y-2.5">
        ...
        <form onSubmit={handleSubmit} className="space-y-2.5" noValidate>
          ...
          <div className="pt-0.5">
            <label className="flex items-start gap-2 text-[11px] text-neutral-600 font-medium select-none cursor-pointer leading-tight">
              <input
                type="checkbox"
                checked={acceptTerms}
                onChange={(e) => {
                ...
                className="mt-0.5 h-3.5 w-3.5 rounded border-neutral-300 text-black focus:ring-black accent-black cursor-pointer"
              />
              <span>
                I agree to the{" "}
